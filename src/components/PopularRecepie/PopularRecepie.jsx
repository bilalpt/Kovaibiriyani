            ...
            {PopularRecepieData.map((item)=>{
                return(
                    <div className='group space-y-3 text-center bg-white/50 shadow-xl p-3 rounded-xl mt-8 md:mt-0'>
                        ...
                        duration-700' />
                        <div className=' '>
                            <button className='btn-primary group-hover:mb-3 opacity-0 group-hover:opacity-100 rounded-xl bg-green-800 text-white h-7 w-20 cursor-pointer'>Buy Now</button>
